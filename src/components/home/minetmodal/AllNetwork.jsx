...
const AllNetwork = ({ selectedNetwork, handleChangeNetwork, changeNetworkPage, handleClose }) => {
  ...
  return (
    <div className="w-full sm:w-[400px] relative">
      ...
      <div className="w-full p-4 sticky bottom-0 bg-white">
        <button onClick={()=>changeNetworkPage("custome")} className="w-full border border-blue-700 hover:bg-blue-700 hover:text-white rounded-full text-blue-700 font-medium h-12">
